...
(options={series:[{name:"總廣告費",type:"area",data:[82097,
    ...
    91672,
    8871]},
{name:"總觸及數",type:"bar",data:[235119,
    338259,
    334372,
    113606,
    189664,
    ...
    177367,
    17165]},
{name:"選取店家總廣告費",type:"line",data:[0, 0, 0, 0, 0, 0, 0, 0, 88663, 12779, 11543, 33748, 40961, 42326, 40961, 367, 599, 580, 599, 580, 599, 0, 953, 21640, 85426, 116359, 112605, 116359, 11261]}],chart:{height:370,type:"line",toolbar:{show:!1}},stroke:{curve:"straight",dashArray:[0,0,8],width:[2,0,2.2]},fill:{opacity:[.1,.9,1]},markers:{size:[0,0,0],strokeWidth:2,hover:{size:4}},
xaxis:{categories:["2020-04","2020-05","2020-06","2020-07","2020-08","2020-09","2020-10","2020-11","2020-12","2021-01","2021-02",
"2021-03","2021-04","2021-05","2021-06","2021-07","2021-08","2021-09","2021-10","2021-11","2021-12","2022-01","2022-02","2022-03",
"2022-04","2022-05","2022-06","2022-07","2022-08"],axisTicks:{show:!1},axisBorder:{show:!1}},grid:{show:!0,xaxis:{lines:{show:!0}},yaxis:{lines:{show:!1}},padding:{top:0,right:-2,bottom:15,left:10}},legend:{show:!0,horizontalAlign:"center",offsetX:0,offsetY:-5,markers:{width:9,height:9,radius:6},itemMargin:{horizontal:10,vertical:0}},plotOptions:{bar:{columnWidth:"30%",barHeight:"70%"}},colors:linechartcustomerColors,tooltip:{shared:!0,y:[{formatter:function(e){return void 0!==e?e.toFixed(0):e}},{formatter:function(e){return void 0!==e?"$"+e.toFixed(2)+"k":e}},{formatter:function(e){return void 0!==e?e.toFixed(0)+" Sales":e}}]}},(chart=new ApexCharts(document.querySelector("#customer_impression_charts"),options)).render());var counterValue=document.querySelector(".counter-value");counterValue&&(counter=document.querySelectorAll(".counter-value"),speed=250,counter&&Array.from(counter).forEach(function(i){!function e(){var t=+i.getAttribute("data-target"),r=+i.innerText,a=t/speed;a<1&&(a=1),r<t?(i.innerText=(r+a).toFixed(0),setTimeout(e,1)):i.innerText=t}()}));var swiper,VerticalSwiper=document.querySelector(".vertical-swiper");VerticalSwiper&&(swiper=new Swiper(".vertical-swiper",{slidesPerView:2,spaceBetween:10,mousewheel:!0,loop:!0,direction:"vertical",autoplay:{delay:2500,disableOnInteraction:!1}}));

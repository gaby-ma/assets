...
linechartcustomerColors&&(options={
    ...
    {
        name:"選取店家廣告費",type:"line",data:[0, 0, 0, 0, 0, 0, 0, 0, 50285, 6961, 6287, 12214, 13899, 14362, 13899, 40, 65, 62, 65, 62, 65, 0, 459, 12804, 50180, 62726, 60702, 62726, 6070]
    }
    {
        name:"選取店家觸及數",type:"line",data:[0, 0, 0, 0, 0, 0, 0, 0, 88663, 12779, 11543, 33748, 40961, 42326, 40961, 367, 599, 580, 599, 580, 599, 0, 953, 21640, 85426, 116359, 112605, 116359, 11261]
    }
    ],
    chart:{
        height:370,
